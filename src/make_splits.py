...
"""
import datetime, os, sys, json, argparse, multiprocessing
import pathlib
...
if __name__ == "__main__":
    ...
    submission_id_to_runtime_map_no_nans = read_submission_id_to_runtime_map(args) if args.submission_id_to_runtime_map else None # todo: 1
    ...
    data = read_and_filter_pairs( # todo: 2
        args.data_file_path,
    ...
    run_split_gen(data, basedir=args.output_dir) # todo: 3
